...
recorded per corner, over a 9-corner process × temperature × voltage set).
...
shipped with read SNM / hold SNM / access-time results recorded; write
margin and the formal per-corner pass/fail record still in progress).**
